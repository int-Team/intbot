...
module.exports = {
	...
	run: async (client, message, args) => {
		const userID = message.mentions.members.first() ? message.mentions.members.first().id : args[1];
